...
class ComprehensiveDiagnosis {
    ...
    generateResultsCards(results) {
        const cardsData = [
            ...
            },
            {
                id: 'disease',
                icon: 'fas fa-virus',
                title: { ar: 'المرض المشتبه به', en: 'Suspected Disease' },
                content: this.renderDiseaseContent(results.disease)
            },
            {
                id: 'reason',
                icon: 'fas fa-brain',
                title: { ar: 'السبب', en: 'Reason' },
            ...
            },
            {
                ...
                title: { ar: 'طرق الوقاية', en: 'Prevention' },
        ...
        return `
            ...
            ${breedData.alternatives ? `
                <div style="margin-top: 1rem;">
                    <strong>البدائل المقترحة:</strong>
    ...
    renderDiseaseContent(diseaseData) {
        return `
            ...
            ${diseaseData.alternatives ? `
                <div style="margin-top: 1rem;">
                    <strong>أمراض أخرى محتملة:</strong>
        ...
        return `
            <div style="line-height: 1.8;">
                ...
                <div style="margin-top: 1rem; padding: 1rem; background: rgba(67,97,238,0.05); border-radius: 8px;">
                    <strong>الأدلة المستخدمة:</strong>
    ...
    updateLanguage() {
        // Update card titles
        document.querySelectorAll('.card-title-text').forEach((element, index) => {
            // This would need to be connected to the original data structure
            // For now, we'll just toggle between placeholder texts
        });
    ...
    async exportPdf() {
        ...
        link.href = '#';
        link.download = 'تقرير-التشخيص-الشامل.pdf';
        link.click();
    }
